...
console.log(`Welcome to The Path, ${playerCharacter.name}.`)
console.log("Here you will continue walking down the path fighting random monsters, and collecting their coins.")
...
monstersInGame.push(new MonsterCreator("Giant Troll", 10, 1, 7)) 
...
while(playerCharacter.hp > 0) {
    playerCommands = readline.question("TWhat would you like to do: ");
